                ...
                match self.host.refresh_workspace_for_mutation() {
                    Ok(refresh) => run.record_phase(
                        ...
                        &json!({
                            ...
                            "lockWaitMs": refresh.metrics.lock_wait_ms,
                            "lockHoldMs": refresh.metrics.lock_hold_ms,
                            "fsRefreshMs": refresh.metrics.fs_refresh_ms,
                            "snapshotRevisionsMs": refresh.metrics.snapshot_revisions_ms,
                            "loadEpisodicMs": refresh.metrics.load_episodic_ms,
                            "loadInferenceMs": refresh.metrics.load_inference_ms,
                            "loadCoordinationMs": refresh.metrics.load_coordination_ms,
                            "workspaceReloaded": refresh.metrics.workspace_reloaded,
                        }),
                        refresh_started.elapsed(),
                        true,
                        None,
