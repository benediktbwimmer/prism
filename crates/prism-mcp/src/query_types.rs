...
use prism_ir::{
    ...
    LeaseRenewalMode, NodeId, NodeKind, PlanBinding, PlanNodeKind, PlanScope, PlanStatus,
    ReviewVerdict, ValidationRef,
};
use prism_memory::{
...
use crate::{
    ...
    OutcomeKindInput, OutcomeResultInput, PlanBindingPayload, PlanNodeKindInput,
