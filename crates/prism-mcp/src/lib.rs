...
use prism_agent::{InferenceStore, InferredEdgeScope};
use prism_coordination::{AcceptanceCriterion, CoordinationPolicy};
use prism_core::{index_workspace_session, WorkspaceSession};
use prism_ir::{
    AnchorRef, ArtifactId, Capability, ClaimMode, CoordinationTaskId, CoordinationTaskStatus,
    EdgeKind, NodeId, NodeKind, PlanId, ReviewVerdict, TaskId,
};
use prism_js::{
...
use prism_memory::{
    EpisodicMemory, MemoryModule, OutcomeEvent, OutcomeEvidence, OutcomeKind, OutcomeResult,
    RecallQuery,
};
...
#[derive(Debug, Clone, serde::Serialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
struct ResourceSchemaCatalogEntry {
...
#[derive(Debug, Clone, serde::Serialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
struct ResourceSchemaCatalogPayload {
    uri: String,
    schema_uri: String,
    schemas: Vec<ResourceSchemaCatalogEntry>,
    related_resources: Vec<ResourceLinkView>,
}
...
struct CoordinationPolicyPayload {
    ...
    require_validation_for_completion: Option<bool>,
...
struct TaskUpdatePayload {
    ...
    title: Option<String>,
    anchors: Option<Vec<AnchorRefInput>>,
    completion_context: Option<TaskCompletionContextPayload>,
}

#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
struct TaskCompletionContextPayload {
...
#[derive(Debug, Deserialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
struct PrismCuratorPromoteMemoryArgs {
    #[serde(alias = "job_id")]
    job_id: String,
    #[serde(alias = "proposal_index")]
    proposal_index: usize,
    ...
    async fn list_resource_templates(
        ...
        Ok(ListResourceTemplatesResult {
            ...
            resource_templates: vec![
                ...
                .no_annotation(),
                RawResourceTemplate::new(
                    SCHEMA_RESOURCE_TEMPLATE_URI,
                    "PRISM Resource Schema",
                )
                .with_description(
