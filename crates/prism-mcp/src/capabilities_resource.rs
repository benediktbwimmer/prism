...
use crate::{
    ...
    TOOL_ACTION_RECIPE_RESOURCE_TEMPLATE_URI, TOOL_ACTION_SCHEMA_RESOURCE_TEMPLATE_URI,
    TOOL_ACTION_SHAPE_RESOURCE_TEMPLATE_URI, TOOL_EXAMPLE_RESOURCE_TEMPLATE_URI, TOOL_SCHEMAS_URI,
    TOOL_SCHEMA_RESOURCE_TEMPLATE_URI, TOOL_SHAPE_RESOURCE_TEMPLATE_URI,
    TOOL_VARIANT_EXAMPLE_RESOURCE_TEMPLATE_URI, TOOL_VARIANT_RECIPE_RESOURCE_TEMPLATE_URI,
    TOOL_VARIANT_SCHEMA_RESOURCE_TEMPLATE_URI, TOOL_VARIANT_SHAPE_RESOURCE_TEMPLATE_URI,
...
pub(crate) fn query_method_specs() -> Vec<(
    ...
    vec![
        ...
        ("task", "coordination", Some("workflow"), "Read one task."),
        (
            "readyTasks",
            "coordination",
            Some("workflow"),
...
fn resource_template_capabilities() -> Vec<ResourceTemplateCapabilityView> {
    vec![
        ...
        ResourceTemplateCapabilityView {
            ...
            shape_uri: Some(tool_action_shape_resource_uri(
                "prism_mutate",
                "validation_feedback",
            )),
        },
        ResourceTemplateCapabilityView {
            ...
            shape_uri: Some(tool_variant_shape_resource_uri(
                "prism_mutate",
                "coordination",
                "plan_bootstrap",
            )),
