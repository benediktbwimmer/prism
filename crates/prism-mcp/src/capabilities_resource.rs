...
use crate::{
    API_REFERENCE_URI, CAPABILITIES_SECTION_RESOURCE_TEMPLATE_URI, CAPABILITIES_URI,
    CONTRACTS_RESOURCE_TEMPLATE_URI, CONTRACTS_URI, CapabilitiesBuildInfoView,
    CapabilitiesResourcePayload, EDGE_RESOURCE_TEMPLATE_URI, ENTRYPOINTS_RESOURCE_TEMPLATE_URI,
    EVENT_RESOURCE_TEMPLATE_URI, FILE_RESOURCE_TEMPLATE_URI, FeatureFlagsView,
    LINEAGE_RESOURCE_TEMPLATE_URI, MEMORY_RESOURCE_TEMPLATE_URI, PLAN_RESOURCE_TEMPLATE_URI,
    PLANS_RESOURCE_TEMPLATE_URI, PLANS_URI, PROTECTED_STATE_URI, PrismMcpFeatures, QueryHost,
    QueryMethodCapabilityView, RESOURCE_EXAMPLE_RESOURCE_TEMPLATE_URI,
    RESOURCE_SHAPE_RESOURCE_TEMPLATE_URI, ResourceCapabilityView, ResourceTemplateCapabilityView,
    RuntimeCapabilitiesView, SCHEMAS_URI, SEARCH_RESOURCE_TEMPLATE_URI, SELF_DESCRIPTION_AUDIT_URI,
    ...
    TOOL_ACTION_SHAPE_RESOURCE_TEMPLATE_URI, TOOL_EXAMPLE_RESOURCE_TEMPLATE_URI,
    TOOL_SCHEMA_RESOURCE_TEMPLATE_URI, TOOL_SCHEMAS_URI, TOOL_SHAPE_RESOURCE_TEMPLATE_URI,
    TOOL_VARIANT_EXAMPLE_RESOURCE_TEMPLATE_URI, TOOL_VARIANT_RECIPE_RESOURCE_TEMPLATE_URI,
    TOOL_VARIANT_SHAPE_RESOURCE_TEMPLATE_URI, ToolCapabilityView,
    VOCAB_ENTRY_RESOURCE_TEMPLATE_URI, VOCAB_URI, capabilities_resource_uri,
    capabilities_resource_view_link, capabilities_section_resource_uri,
