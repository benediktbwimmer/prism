use prism_js::{
    ChangeImpactView, CoChangeView, ConceptProvenanceView, ConceptPublicationView,
    ConceptScopeView, DiscoveryBundleView, EdgeView, EditContextView, LineageEventView,
    LineageStatus, LineageView, MemoryEntryView, MemoryEventView, OwnerCandidateView,
    PlanListEntryView, QueryDiagnostic, ReadContextView, RelationsView, SuggestedQueryView,
...
pub(crate) enum ContractKindView {
    Interface,
    Behavioral,
    DataShape,
    DependencyBoundary,
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, JsonSchema)]
#[serde(rename_all = "snake_case")]
pub(crate) enum ContractStatusView {
    Candidate,
    Active,
    Deprecated,
    Retired,
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, JsonSchema)]
#[serde(rename_all = "snake_case")]
pub(crate) enum ContractStabilityView {
    Experimental,
    Internal,
    Public,
    Deprecated,
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, JsonSchema)]
#[serde(rename_all = "snake_case")]
pub(crate) enum ContractGuaranteeStrengthView {
    Hard,
    Soft,
    Conditional,
}
...
#[derive(Debug, Clone, serde::Serialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub(crate) struct ContractTargetView {
    pub(crate) anchors: Vec<AnchorRefView>,
    pub(crate) concept_handles: Vec<String>,
}

#[derive(Debug, Clone, serde::Serialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub(crate) struct ContractGuaranteeView {
    pub(crate) statement: String,
    pub(crate) scope: Option<String>,
    pub(crate) strength: Option<ContractGuaranteeStrengthView>,
    pub(crate) evidence_refs: Vec<String>,
}

#[derive(Debug, Clone, serde::Serialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub(crate) struct ContractValidationView {
    pub(crate) id: String,
...
#[derive(Debug, Clone, serde::Serialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub(crate) struct ContractCompatibilityView {
    pub(crate) compatible: Vec<String>,
    pub(crate) additive: Vec<String>,
    pub(crate) risky: Vec<String>,
    pub(crate) breaking: Vec<String>,
    pub(crate) migrating: Vec<String>,
}

#[derive(Debug, Clone, serde::Serialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub(crate) struct ContractResolutionView {
    pub(crate) score: i32,
...
#[derive(Debug, Clone, serde::Serialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub(crate) struct ContractPacketView {
    pub(crate) handle: String,
    pub(crate) name: String,
    pub(crate) summary: String,
    pub(crate) aliases: Vec<String>,
    pub(crate) kind: ContractKindView,
    pub(crate) subject: ContractTargetView,
    pub(crate) guarantees: Vec<ContractGuaranteeView>,
    pub(crate) assumptions: Vec<String>,
    pub(crate) consumers: Vec<ContractTargetView>,
    pub(crate) validations: Vec<ContractValidationView>,
    pub(crate) stability: ContractStabilityView,
    pub(crate) compatibility: ContractCompatibilityView,
    pub(crate) evidence: Vec<String>,
    pub(crate) status: ContractStatusView,
    pub(crate) scope: ConceptScopeView,
    pub(crate) provenance: ConceptProvenanceView,
    pub(crate) publication: Option<ConceptPublicationView>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) resolution: Option<ContractResolutionView>,
}
