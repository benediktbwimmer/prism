...
pub use coordination_authority_store::{
    ...
    CoordinationAppendRequest, CoordinationAuthorityBackendConfig,
    CoordinationAuthorityBackendDetails, CoordinationAuthorityBackendKind,
    CoordinationAuthorityCapabilities, CoordinationAuthorityCurrentStateStore,
    ...
    CoordinationAuthorityMutationStore, CoordinationAuthorityProvenance,
    CoordinationAuthorityRuntimeStore, CoordinationAuthoritySnapshotStore,
    CoordinationAuthorityStamp, CoordinationAuthorityStore, CoordinationAuthorityStoreProvider,
