...
schema_types! {
    ...
    "SpecListEntryView" => crate::SpecListEntryView,
    "SpecChecklistItemView" => crate::SpecChecklistItemView,
    "SpecDocumentView" => crate::SpecDocumentView,
    "SpecCoverageRecordView" => crate::SpecCoverageRecordView,
    "SpecSyncProvenanceRecordView" => crate::SpecSyncProvenanceRecordView,
    "SpecSyncBriefView" => crate::SpecSyncBriefView,
