...
- [2026-04-10-prism-code-canonical-surface.md](./2026-04-10-prism-code-canonical-surface.md) — ADR: `prism_code` As The Canonical Programmable Surface — `Status: accepted`
