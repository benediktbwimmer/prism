...
When a major architectural decision changes the intended public API or runtime model:

1. add or update the relevant ADR in `docs/adrs/`
2. add or update the corresponding design doc in `docs/designs/`
3. update the affected contracts, roadmaps, and user-facing instruction docs in the same change
...
- [contracts/README.md](./contracts/README.md) — 35 indexed markdown documents
- [designs/README.md](./designs/README.md) — 38 indexed markdown documents
- [specs/README.md](./specs/README.md) — 81 indexed markdown documents
- [roadmaps/README.md](./roadmaps/README.md) — 7 indexed markdown documents
- [adrs/README.md](./adrs/README.md) — 4 indexed markdown documents
