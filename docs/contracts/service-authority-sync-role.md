...
- any enabled service-owned coordination materialization advances from one sync owner rather than
  many runtime local stores
...
- triggers for any enabled service-local coordination materialization and checkpoint refresh
