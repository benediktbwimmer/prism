...
- `prism://instructions/{id}` for the concrete role-specific instruction set

The runtime source of truth is the modular markdown hierarchy in that folder, not this file.
